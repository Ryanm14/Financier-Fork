...
export class Account {
    ...
    private cache: AccountCacheData;
    private _clearedValueChangeFn: (val: any) => void;
    private _unclearedValueChangeFn: (val: any) => void;
    private _transferClearedValueChangeFn: (val: any) => void;
    private _transferUnclearedValueChangeFn: (val: any) => void;
    private fn: any;
    ...
    constructor(data: any) {
        const myData: AccountData = angular.extend({
            type: null,
            closed: false,
            name: null,
            note: null,
        ...
        if (!myData._id) {
            myData._id = Account.prefix + uuidv4();
        }
     ...
     * @private
     */
    _changeClearedBalance(val: number) {
     ...
     * @private
     */
    _changeUnclearedBalance(val: number) {

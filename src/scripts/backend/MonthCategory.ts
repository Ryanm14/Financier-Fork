...
class MonthCategory {
    ...
    categoryId: string;
    private fn: any;
    private budgetFn: any;
    private overspendingFn: any;
    ...
    constructor(data: any) {
        ...
        const myData: MonthCategoryData = angular.extend({
            budget: 0,
            overspending: null,
            note: null
        }, data);
    ...
    private _data: MonthCategoryData;
     ...
     * @private
     */
    static _fromId(budgetId: string, monthId: string, categoryId: string) {
     ...
     */
    static from(budgetId: string, monthId: string, categoryId: string) {
     ...
     * as a MonthCategory.
     */
    static contains(budgetId: string, _id: string) {

...
export class MonthManager {
     ...
     */
    constructor(months: Month[] = [], saveFn: any) {
    ...
    addTransaction(trans: Transaction) {
        ...
        trans.removeTransaction = (t: Transaction) => this.removeTransaction(t);
        trans.addTransaction = (t: Transaction) => this.addTransaction(t);

        trans.subscribeAccountChange((newAccountId: string, oldAccountId: string) => {
        ...
        trans.subscribeMonthChange((newMonth: Date, oldMonth: Date) => {
     ...
     */
    addMonthCategory(monthCat: MonthCategory) {
     ...
     * @private
     */
    _linkMonths(firstMonth: Month, secondMonth: Month) {
     ...
     */
    propagateRolling(categoryIds: string[]) {
     ...
     * @private
     */
    _propagateRollingFromMonth(month: Month) {
